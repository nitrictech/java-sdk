...
public class SecretsTest {
    ...
    public void test_secret() {
        ...
        var secret = new Secrets().secret("name");
    ...
    public void test_secret_version() {
        var secretVersion = new Secrets().secret("name").version("version");
        ...
        try {
            new Secrets().secret("name").version(" ");
            fail();
        } catch (IllegalArgumentException iae) {
        }
    }
    ...
    public void test_secret_latest() {
        var secretVersion = new Secrets().secret("name").latest();
        assertNotNull(secretVersion);
        assertEquals("name", secretVersion.getSecret().getName());
    ...
    public void test_secret_put() {
        ...
        var secret = new Secrets().secret("name").put(value);
        ...
        var secret2 = new Secrets().secret("name").putAsText("password");
        ...
        try {
            new Secrets().secret("name").put(null);
            fail();
        } catch (IllegalArgumentException iae) {
        }
        ...
        var secret3 = new Secrets().secret("name");
        try {
    ...
    public void test_secret_version_access() {
        ...
        var secretValue = new Secrets().secret("name").version("version").access();
        ...
        var version = new Secrets().secret("name").version("version");
        try {
            version.access();
            fail();
        } catch (NitricException ne) {
    ...
    public void javadoc_example() {
        ...
        String password = new Secrets().secret("jdbc.password")
                .latest()
                .access()
                .getAsText();
        ...
        // decrypt the record.
        SecretValue value = new Secrets().secret("encryption.key").latest().access();
