...
public class InvalidArgumentException extends NitricException {
    ...
    /**
     * Create a Nitric API resource Invalid Argument Exception with the given code, message and cause.
     *
     * @param code the GRPC error code
     * @param message the error message
     * @param cause the error cause
     */
    public InvalidArgumentException(Code code, String message, Throwable cause) {
