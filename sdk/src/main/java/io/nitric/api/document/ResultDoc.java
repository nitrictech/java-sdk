...
public class ResultDoc<T> {
    ...
    /**
     * Create a new ResultDoc with the given content. Note this convience
     * constructor is provided for unit testing, the Query service will always
     * populate the ResultDoc key.
     *
     * @param content the document content
     */
