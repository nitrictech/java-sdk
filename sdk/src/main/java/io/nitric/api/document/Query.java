 ...
 *  QueryResults results = new Documents().collection("customers")
 *      .query()
 *      .limit(100)
 *      .fetch();
 *
 ...
 *
 *  QueryResults&lt;Customer&gt; results = new Documents().collection("customers")
 ...
 *  QueryResults results = new Documents().collection("customers").collection("orders")
 *      .query(Order.class)
 *      .fetch();
 *
 *  results.foreach(doc -&gt; {
 ...
 *  QueryResults&lt;Order&gt; results = new Documents().collection("customers").doc("jane-smith@server.com")
 *      .collection("orders")
 *      .query(Order.class)
 *      .fetch();
 *
 ...
 *
 *  Stream&lt;ResultDoc&lt;Map&gt;&gt; stream = new Documents().collection("customers")
 *      .query()
 *      .stream();
 *
 *  stream.foreach(doc -&gt; {
 ...
 *  import io.nitric.api.document.QueryResults;
 *
 *  Query query = new Documents().collection("customers")
 *      .query()
 *      .where("status", "==", "active")
 *      .limit(100);
 *
