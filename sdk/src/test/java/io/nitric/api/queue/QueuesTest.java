...
public class QueuesTest {
    ...
    public void test_queue() {
        Queue queue = new Queues().queue("orders");
    ...
    public void test_send() {
        ...
        var queue = new Queues().queue("queue");
    ...
    public void test_sendBatch_none() {
        new Queues().queue("queue").sendBatch(new ArrayList<>());
    }
    ...
    public void test_failed_task_translation() {
        ...
        var queues = new Queues().queue("queue");
    ...
    public void test_sendBatch_empty() {
        try {
            new Queues().queue("queue").sendBatch(null);
            fail();
        } catch (IllegalArgumentException iae) {
