...
public class StorageTest {
    ...
    public void test_bucket() {
        var bucket = new Storage().bucket("images");
    ...
    public void test_bucket_file() {
        var file = new Storage().bucket("images").file("todo.txt");
        ...
        try {
            new Storage().bucket("images").file(" ");
            fail();
        } catch (IllegalArgumentException iae) {
    ...
    public void test_bucket_file_read() {
        ...
        Storage.setServiceStub(mock);
        var bucket = new Storage().bucket("bucket");
    ...
    public void test_read_unknown_key() {
        ...
        var data = new Storage().bucket("bucket").file("unknown key").read();
        assertNull(data);
    }
    ...
    public void test_bucket_file_write() {
        ...
        var file2 = new Storage().bucket("bucket").file("this key");
        try {
            file2.write(data);
            fail();
    ...
    public void test_bucket_file_delete() {
        ...
        new Storage().bucket("bucket").file(KNOWN_KEY).delete();
        ...
        var file = new Storage().bucket("bucket").file(KNOWN_KEY);
        try {
            file.delete();
            fail();
        } catch (NotFoundException nfe) {
